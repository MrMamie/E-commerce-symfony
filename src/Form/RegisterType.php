    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('lastname', TextType::class, [
                'label' => 'Votre nom', 'constraints' => new Length(['min' => 3, 'max' => 60]),
                'attr' => ['placeholder' => 'Saisir votre nom']
            ])
            ->add('email', EmailType::class, [
                'label' => 'Votre mail',
                'constraints' => new Length(['min' => 3, 'max' => 60]), 'attr' => ['placeholder' => 'Saisir votre mail']
            ])
            ->add('password', RepeatedType::class, [
                ...
                'second_options' => ['label' => 'Confirmez mot de passe', 'attr' => ['placeholder' => 'Confirmez votre mot de passe']]
            ])
